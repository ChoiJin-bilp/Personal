    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (res.data.rspCode == 0 && res.data.data != null && res.data.data != undefined) {
          ...
          var id = 0, type = 0, typeValue = "",partner_trade_no="", money = 0.00, createDate = "", cDate = null,tag=0;
          for (var i = 0; i < data.length; i++) {
            id = 0; type = 0; typeValue = "";partner_trade_no=""; money = 0.00; createDate = ""; cDate = null;tag=0;
            ...
            listItem = {
              id: id, type: type, typeValue: typeValue,partner_trade_no:partner_trade_no, money: money, createDate: createDate,tag:tag,
            }
