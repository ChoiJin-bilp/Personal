...
App({
  ...
  data: {
    ...
    walletdetailTypeList:[
      ...
      {id:17,name:"签到金额",tag:"+"},{id:18,name:"余额支付",tag:"-"}
    ],
    //积分明细类型
    integralTypeList:[
  ...
  filterPrintImgList:function(printAllImgList){
    ...
    let pSysImgList = [],pMyImgList=[],pOtherImgList=[],dataItem=null;
    let appUserInfo = app.globalData.userInfo;
    ...
    let printImageInfo={
      printAllImgList:printAllImgList,pSysImgList:pSysImgList,pOtherImgList:pOtherImgList,pMyImgList:pMyImgList,
    }
